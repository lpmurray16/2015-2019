...
object argpass {
  ...
  // It has one parameter f: a function that takes an instance of RefInt (see above for the definition of the class RefInt) 
  // and returns Unit (i.e., nothing interesting).
