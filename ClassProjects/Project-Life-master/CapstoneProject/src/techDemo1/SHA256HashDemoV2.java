...
public class SHA256HashDemoV2 {
	public static void main(String[] args) throws Exception {
		...
		File dir = new File("C:/Users/Logan Murray/Desktop/CS programs/CSC 394/Project-Life-master/Capstone Project"); //for testing purposes, change this line to your directory path
		...
		//Note: this has N^2 runtime and as such should only be used for testing purposes on small data sets.
