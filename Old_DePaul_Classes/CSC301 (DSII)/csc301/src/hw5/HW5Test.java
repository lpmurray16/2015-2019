...
public class HW5Test {
	...
	public void toyTest() {
		...
		grid1 = GridUtilities.fromStringArray(data1);
		String solution1 = Solver.solve(grid1);
		checkSol(grid1, solution1, 18);
		
		//Hardcoded solution does not solve this grid 
		grid1 = GridUtilities.rotateClockwise(grid1);
		solution1 = Solver.solve(grid1);
		checkSol(grid1, solution1, 18);
	}
