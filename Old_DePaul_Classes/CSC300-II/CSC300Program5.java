...
public class CSC300Program5 {
	...
	public int sizeHelper(Node temp) {
		if(temp==null) return 0;
		
		return 1 + sizeHelper(temp.next);
	}
	...
	public int sumOfLastTwo ( ) {
		...
		sum = start.item + second.item;
		
		return sum; //TODO 4: fix this
	}
